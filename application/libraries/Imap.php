 ...
 *
 * @package    protocols
 * @copyright  Copyright (c) Vivek Kapoor (http://www.xoosolutions.com)
 * @license    GPLv3 (http://www.gnu.org/licenses/gpl-3.0.html)
 * @author     Vivek Kapoor <webmaster@synpat.com>
 */
class Imap {
    ...
    public function __construct($credential = array()) {
        $enc = '';
        if($credential['encryption']!=null && isset($credential['encryption']) && $credential['encryption']=='ssl')
    ...
    protected function formatMessage($id, $withbody=true){
		...
		$overview = imap_fetch_overview($this->imap,$id,0);
		// fetch unique uid
