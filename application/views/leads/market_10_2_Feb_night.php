...
<div class="panel dashboard-box">
    <div class="panel-body">
		<div class="example-box-wrapper">
			...
			<?php echo form_close();?>
			<?php echo form_open('leads/market',array('class'=>'form-horizontal form-flat','role'=>'form','style'=>'margin-top:20px;','id'=>"marketLead","onsubmit"=>"return dataValidate();"));?>
				<div class="row">
					<div class="col-lg-12">
				...
				<div class="row mrg10T">
					...
					<div class="col-xs-2" style="width:10%;">
						<select  class="form-control" name="market[attractive]" required="required">
				...
				<div class="row mrg10T">
					...
					<div class="col-xs-2 text-right" style="margin-top:7px;">
