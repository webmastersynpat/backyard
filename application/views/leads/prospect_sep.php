	...
	<script>
		...
		_senddt = '<?php echo $this->session->userdata['id'];?>';
					...
					function record(level){
						...
						jQuery.ajax({
							...
							data:{token:jQuery("#token").val(),level:level,type:'SEP',complete:0},
							...
							success:function(response){				
								...
								if(response.results.length>0){
                                    ...
                                    jQuery("#sepPatentData").val(_data.patent_data);
	   ...
	   <script>
		...
		<div class="example-box-wrapper">
			...
			?>
			<?php echo form_open('leads/proactive_sep',array('id' => 'formProspectSep', 'class'=>'form-horizontal form-flat','role'=>'form',"onsubmit"=>"return dataValidate();"));?>
			<div class="row row-width">
						...
						<div class="row">
							<div class="col-xs-4">
								<div class="form-group input-string-group">
									...
									<?php echo form_input(array('name'=>'general[lead_name]','required'=>"required",'id'=>'generallead_name','placeholder'=>'','class'=>'form-control'));?>
								</div>
					  		</div>
							<div class="col-xs-8 text-right">
								<label style="display: inline-block; margin-top: 7px; margin-right: 30px;">
							  	...
							  	<button type="submit" class="btn btn-primary pull-right btn-mwidth">Save</button>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-xs-4">
						<div class="form-group input-string-group bigmr">
							...
							<?php echo form_input(array('name'=>'general[plantiffs_name]','id'=>'generalOwner','placeholder'=>'','class'=>'form-control'));?>
						</div>
					...
					<div class="col-xs-4">
						<div class="form-group input-string-group bigmr">
							...
							<?php echo form_input(array('name'=>'general[relates_to]','id'=>'generalRelatesTo','placeholder'=>'','class'=>'form-control'));?>
						</div>
						<div class="form-group input-string-group bigmr">
							<label for="generalExpectedPrice" class="control-label">Person Name1:</label>
							<?php echo form_input(array('name'=>'general[person_name_1]','id'=>'generalPersonName1','placeholder'=>'','class'=>'form-control'));?>
						</div>
						<div class="form-group input-string-group bigmr">
							<label for="generalTechnologies" class="control-label">Person Title1:</label>
							<?php echo form_input(array('name'=>'general[person_title_1]','id'=>'generalPersonTitle1','placeholder'=>'','class'=>'form-control'));?>
						</div>
					</div>
					<div class="col-xs-4">
						<div class="form-group input-string-group nomr">
							<label for="generalProspects" class="control-label">Number of Patents:</label>
							<?php echo form_input(array('name'=>'general[no_of_prospects]','id'=>'generalProspects','placeholder'=>'','class'=>'form-control'));?>
						</div>
						<div class="form-group input-string-group nomr">
							<label for="generalExpectedPrice" class="control-label">Person Name2:</label>
							<?php echo form_input(array('name'=>'general[person_name_2]','id'=>'generalPersonName2','placeholder'=>'','class'=>'form-control'));?>
						</div>
						<div class="form-group input-string-group nomr">
							<label for="generalTechnologies" class="control-label">Person Title2:</label>
							<?php echo form_input(array('name'=>'general[person_title_2]','id'=>'generalPersonTitle2','placeholder'=>'','class'=>'form-control'));?>
						</div>
				...
				<div class="row mrg10T">
					...
					<div class="col-xs-2" style="width:10%;">
						<select  class="form-control" name="general[attractive]">
				...
				<div class="row mrg10T">
					<!--div class="col-xs-9">
						<div class="form-group">
							...
							<input type="textbox" class="form-control input-string" name="general[file_url]" id="litigationFileUrl" value=""/>
						</div>						
					</div-->
                    <div class="col-xs-2">
                        <div class="form-group">
					...
					<div class="col-xs-4 text-right" style="margin-top:7px;">
