								...
								<div class="row">
									<div class="col-sm-4">
										<div class="form-group input-string-group">
											...
											<input type="text" value="<?php echo $results[0]['litigation']->lead_name;?>" readonly="readonly" class="form-control" placeholder="" id="marketlead_name" required="required" />
										</div>
									</div>
									<div class="col-sm-8">
...
<?php echo form_open('leads/comment',array('class'=>'form-horizontal bordered-row form-flat','role'=>'form','id'=>'leadComment' ,"return dataValidate();"));?>
...
<link rel="stylesheet" media="screen" href="<?php echo $Layout->baseUrl?>public/assets/lib/jQuery-contextMenu/jquery.contextMenu.css">
           ...
           //     alert(_ddd);
			...
			<div class="widget-content padding mrg15T">
...
_senddt = '<?php echo $this->session->userdata['id'];?>';
	...
	function userComment(){
        ...
        var $container = jQuery("#scrap_patent_data");
    	hst = $container.data('handsontable');
    	jQuery("#sepPatentData").val(JSON.stringify(hst.getData()));
	...
	function record(level){
		...
		jQuery.ajax({
			...
			data:{token:jQuery("#token").val(),level:level,type:'SEP',complete:1},
