					...
					if(_data.patent_data!=""){
					 ...
					 jQuery("#litigationCreate_patent_list").val(_data.create_patent_list);
                        if(_data.seller_info==1){							
							...
							jQuery("#assign_task").html(moment( new Date(_data.seller_info_text)).format('MM D, YY')+" Seller Info Done");
                        ...
                        if(_data.send_proposal_letter==1){
							...
							jQuery("#request_for_proposal").html(moment( new Date(_data.send_proposal_letter_text)).format('MM D, YY')+" Proposal letter created");
                        ...
                        if(_data.create_patent_list==1){
							...
							jQuery("#create_patent_list").removeClass('btn').removeClass('btn-mwidth').html(moment( new Date(_data.create_patent_list_text)).format('MM D, YY')+" Patent Spreadsheet created");
						...
						if(_data.complete==2){
							jQuery("#forward_to_review").html(moment( new Date(_data.forward_to_review_text)).format('MM D, YY')+" Review");
						...
						if(_data.nda_term_sheet==1){
							jQuery("#ndaTermSheet").html(moment( new Date(_data.nda_term_sheet_text)).format('MM D, YY')+" NDA and TermSheet created");
		 ...
		 <div class="example-box-wrapper">
            ...
            <?php echo form_open('leads/litigation',array('class'=>'form-horizontal form-flat','role'=>'form','id'=>'formLitigation',"onsubmit"=>"return dataValidate();", 'style'=>'margin-bottom: 0;'));?>
				...
				<div class="row row-width mrg10T">
					...
					<div class="col-xs-6">
						<div class="row row-width">
							<div class="col-width" style="width: 120px;">
								<div class="form-group input-string-group">
							...
							<div class="col-width" style="width: 175px;">
								<div class="form-group input-string-group">
									<label for="marketExpectedPrice" class="control-label">Expected Price($M):</label>
									<?php echo form_input(array('name'=>'litigation[expected_price]','id'=>'litigationExpectedPrice','placeholder'=>'','class'=>'form-control', 'maxlength'=>'4', 'style'=>'min-width:38px;'));?>
								</div>
							</div>
						</div>
					</div>
        ...
        jQuery.ajax({
            ...
            success:function(response){
                ...
                if(obj.url != '' && obj.error==0){         
                    ...
                    jQuery("#create_patent_list").html(moment(new Date(obj.date_created)).format('MM D, YY')+" SpreadSheet created");
                    jQuery("#create_patent_list").addClass("btn btn-mwidth");
            ...
            success:function(response){
                $("#loader_seller").hide();
                  obj = jQuery.parseJSON(response);
                    ...
                    jQuery("#assign_task").html(moment(new Date(obj.date_created)).format('MM D, YY')+" Seller Info Done");
            ...
            if(type == 1){
        		...
        		success:function(res){  
						...
						if(_res.error==0){
							...
							jQuery("#request_for_proposal").html(_res.date_created+" Proposal letter created");
        ...
        if(lead_id > 0)
        {
            ...
            jQuery.ajax({
                ...
                success:function(response){
                  ...
                  //  
                    jQuery("#forward_to_review").html(moment( new Date(res.date_created)).format('MM D, YY')+" Review");
            ...
            jQuery.ajax({
                ...
                success:function(response){
					...
					if(_response.error=="0"){
                        ...
                        jQuery("#ndaTermSheet").html(moment( new Date(_response.date_created)).format('MM D, YY')+" NDA and TermSheet created");
					} else {
						alert("Please try after sometime.");
					}
                }
