							...
							<div class="row">
								...
								<div class="col-xs-4">
									<div class="form-group input-string-group">
										...
										<input type="text" class="form-control" value="<?php echo $data['litigation']->expected_price;?>" readonly="readonly">
									</div>
								</div>
								<div class="col-xs-4">
									<div class="form-group input-string-group">
										<label class="control-label" for="marketOwner">Prospect Name:</label>
								...
								'<div class="col-xs-7">' +
									'<div class="row">' +
										...
										'<div class="col-xs-4">' +
											'<div class="form-group input-string-group">' +
												'<label class="control-label" for="marketExpectedPrice">Expected Price:</label>' +
												'<input type="text" class="form-control" value="'+_data.expected_price+'" readonly="readonly" style="width: 30px;">' +
											'</div>' +
										'</div>' +
										'<div class="col-xs-4">' +
											'<div class="form-group input-string-group">' +
						  		...
						  		'<div class="col-xs-5">' +
									'<div class="form-group input-string-group">' +
										'<label class="control-label">' +
											'Name of Lead:' +
										'</label>' +
										'<input type="text" tabindex="11" class="form-control" style="width: 30px;"  readonly="readonly">' +
									'</div>' +
						  		'</div>' +
						  	'</div>';
					...
					if(response.length>0){	
						...
						for(i=0;i<response.length;i++){
							...
							_trData+='<tr>'+
										...
										'<td width="75%">'+response[i].comment+'</td>'+
