			...
			<?php echo form_open('leads/market',array('class'=>'form-horizontal form-flat','role'=>'form','style'=>'margin-top:20px;','id'=>"marketLead"));?>
						...
						<div class="row">
							<div class="col-xs-4">
								<div class="form-group input-string-group">
									...
									<?php echo form_input(array('name'=>'market[no_of_prospects]','id'=>'marketProspects','placeholder'=>'','class'=>'form-control'));?>
								</div>
							</div>
							<div class="col-xs-4">
								<div class="form-group input-string-group">
									<label for="marketExpectedPrice" class="control-label">Expected Price:</label>
									<?php echo form_input(array('name'=>'market[expected_price]','id'=>'marketExpectedPrice','placeholder'=>'','class'=>'form-control'));?>
								</div>
							</div>
							<div class="col-xs-4">
								<div class="form-group input-string-group">
									<label for="marketProspectsName" class="control-label">Prospect's Name:</label>
				...
				<div class="mrg15T">
					<div class="row">
						<div class="col-xs-5">
							<div class="form-group">
								<label for="marketProspectsName" class="control-label" style="float:left;">Name of Lead:</label>
