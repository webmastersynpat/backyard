				...
				<div class="row">
					<div class="col-xs-4">
						<div class="form-group">
							...
							<?php echo form_input(array('name'=>'general[plantiffs_name]','id'=>'generalOwner','placeholder'=>'','class'=>'form-control input-string',"tabindex"=>"1","style"=>"width:67%"));?>
						</div>
					...
					<div class="col-xs-4">
						<div class="col-xs-12">
							...
							<?php echo form_input(array('name'=>'general[relates_to]','id'=>'generalRelatesTo','placeholder'=>'','class'=>'form-control input-string',"tabindex"=>"2","style"=>"width:72%"));?>
						</div>
						<div class="col-xs-12 mrg5T">
							<label for="generalExpectedPrice" class="control-label">Person Name1:</label>
							<?php echo form_input(array('name'=>'general[person_name_1]','id'=>'generalPersonName1','placeholder'=>'','class'=>'form-control input-string',"tabindex"=>"5","style"=>"width:63%"));?>
						</div>
						<div class="col-xs-12 mrg5T">
							<label for="generalTechnologies" class="control-label">Person Title1:</label>
							<?php echo form_input(array('name'=>'general[person_title_1]','id'=>'generalPersonTitle1','placeholder'=>'','class'=>'form-control input-string',"tabindex"=>"7","style"=>"width:67%"));?>
						</div>
					</div>
					<div class="col-xs-4">
						<div class="form-group">
							<label for="generalProspects" class="control-label">Number of Patents:</label>
							<?php echo form_input(array('name'=>'general[no_of_prospects]','id'=>'generalProspects','placeholder'=>'','class'=>'form-control input-string',"tabindex"=>"3","style"=>"width:55%"));?>
						</div>
						<div class="form-group">
							<label for="generalExpectedPrice" class="control-label">Person Name2:</label>
							<?php echo form_input(array('name'=>'general[person_name_2]','id'=>'generalPersonName2','placeholder'=>'','class'=>'form-control input-string',"tabindex"=>"6","style"=>"width:63%"));?>
						</div>
						<div class="form-group">
							<label for="generalTechnologies" class="control-label">Person Title2:</label>
							<?php echo form_input(array('name'=>'general[person_title_2]','id'=>'generalPersonTitle2','placeholder'=>'','class'=>'form-control input-string',"tabindex"=>"8","style"=>"width:67%"));?>
						</div>
						<!-- <div class="form-group">
